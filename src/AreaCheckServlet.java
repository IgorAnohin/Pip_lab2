...
public class AreaCheckServlet extends HttpServlet {
    ...
    private boolean isCircleArea(double x, double y, int r) {
        return (x >= 0 && y >= 0 && (x*x + y*y) <= r*r);
    }

    private boolean isTriangleArea(double x, double y, int r) {
        return (x >= 0 && y <= 0 && (x-r)/2 <= y);
    }

    private boolean isRectangleArea(double x, double y, int r) {
